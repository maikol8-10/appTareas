    ...
    return (
        <li className="lista-tareas__tarea">
            <FontAwesomeIcon icon={tarea.completada ? faCheckSquare : faSquare}
                             ...
                             onClick={() => toggleCompletada(tarea.id)}></FontAwesomeIcon>
            ...
            <div className="lista-tareas__contenedor-botones">
                <FontAwesomeIcon icon={faEdit}
                                 ...
                                 onClick={() => cambiarEditandoTarea(!editandoTarea)}></FontAwesomeIcon>
                <FontAwesomeIcon icon={faTimes}
                                 className="lista-tareas__icono lista-tareas__icono-accion"
                                 onClick={() => borrarTarea(tarea.id)}></FontAwesomeIcon>
            </div>
        </li>
    );
}
